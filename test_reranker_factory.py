...
class TestRerankerFactory:
    ...
    @pytest.mark.asyncio
    async def test_create_hybrid(self, faiss_db: MagicMock, llm_client: MagicMock) -> None:
    ...
    def test_hybrid_reranker_rerank(self, faiss_db: MagicMock, llm_client: MagicMock) -> None:
