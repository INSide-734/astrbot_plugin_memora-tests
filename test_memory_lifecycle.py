...
class TestMemoryLifecycleManager:
    ...
    @pytest.mark.asyncio
    async def test_add_memory_returns_doc_id(self, manager: Any, bm25: MagicMock, vector: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_add_memory_defaults_metadata(self, manager: Any, vector: MagicMock) -> None:
        ...
        metadata = call_args.kwargs["metadata"] if "metadata" in call_args.kwargs else call_args.args[1]
        assert "importance" in metadata
        assert "create_time" in metadata
        assert "last_access_time" in metadata

    @pytest.mark.asyncio
    async def test_update_metadata_success(self, manager: Any, vector: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_metadata_failure(self, manager: Any, vector: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_memory_success(self, manager: Any, bm25: MagicMock, vector: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_memory_bm25_fails(self, manager: Any, bm25: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_memory_vector_delete_fails_rollback(self, manager: Any, bm25: MagicMock, vector: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_memory_backup_fails(self, manager: Any, bm25: MagicMock, vector: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_delete_memory_bm25_delete_raises(self, manager: Any, bm25: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_update_metadata_vector_raises(self, manager: Any, vector: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rollback_no_backup_content(self, manager: Any, bm25: MagicMock) -> None:
    ...
    async def test_rollback_success(self, manager: Any, bm25: MagicMock) -> None:
        ...
        bm25.update_document.assert_called_once_with(1, "restored content", {"importance": 0.5})
